import { OrcamentoComponente as PrismaOrcamentoComponente } from '@/generated/prisma/client.js'
import { OrcamentoComponente } from '@/modules/os-orcamento/domain/entities/orcamento-componente.js'
import { UniqueEntityID } from '@/core/entities/unique-entity-id.js'

export class PrismaOrcamentoComponenteMapper {
  // Transforma o modelo do Prisma (Banco) para Entidade de Domínio
  static toDomain(raw: PrismaOrcamentoComponente): OrcamentoComponente {
    return OrcamentoComponente.criar(
      {
  ...
  static toPrisma(componente: OrcamentoComponente) {
    return {
