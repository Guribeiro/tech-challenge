...
import { Recepcionista, RecepcionistaProps } from '@/modules/os-orcamento/domain/entities/recepcionista.js'
...
export function makeRecepcionista(
  override: Partial<RecepcionistaProps> = {},
  id?: UniqueEntityID
): Recepcionista {
